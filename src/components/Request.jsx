  ...
  return (
    <>
      <div className="w-full h-20 rounded-md shadow-md m-6 ml-0 p-4">
        ...
        <button className="flex flex-column btn btn-outline btn-primary float-right" onClick={()=>document.getElementById('InfoModal').showModal()}>
      ...
      <RequestModal key={info.email} info={info}/>
    </>
  )
};
